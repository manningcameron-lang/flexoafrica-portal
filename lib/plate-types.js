...
// Delivery fee, tiered by order subtotal (excl. VAT).
// Each tier specifies the max subtotal at which it applies. The FIRST tier
// whose maxSubtotal is >= order subtotal is used. Last tier covers everything
// above.
// PLACEHOLDER - Cam to tune the percentages once we see real orders.
export const DELIVERY_TIERS = [
  { maxSubtotal: 500,   percent: 15 },
  { maxSubtotal: 2000,  percent: 10 },
  { maxSubtotal: 5000,  percent: 7  },
  { maxSubtotal: Infinity, percent: 5 },
];
...
// Lookup the delivery fee % for a given pre-VAT subtotal.
