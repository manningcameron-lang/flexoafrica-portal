...
// Four tiers: Crystal (premium HD), Gold (premium specialty),
// Surface Engineered (mid-tier), Standard.
...
export const TIERS = ["Crystal", "Gold", "Surface Engineered", "Standard"];

// Thickness conversions: thou to mm. (1 thou = 0.0254 mm)
// Standard thicknesses across tiers: 45, 67, 100, 112, 125, 155, 185, 250
// (Crystal currently only offers thin specs because of its use case.)
export const PLATE_TYPES = [
  ...
  // Gold tier (premium specialty)
  { id: "G-A",   tier: "Gold", name: "Gold A", thicknessMm: 1.16, useCase: "Premium specialty flexible packaging" },
  ...
  { id: "SE-155", tier: "Surface Engineered", name: "Surface Engineered 155 thou", thicknessMm: 3.94, useCase: "Heavy flexible, corrugated" },
  { id: "SE-185", tier: "Surface Engineered", name: "Surface Engineered 185 thou", thicknessMm: 4.70, useCase: "Heavy corrugated" },
  { id: "SE-250", tier: "Surface Engineered", name: "Surface Engineered 250 thou", thicknessMm: 6.35, useCase: "Thick corrugated, specialty" },
...
// Screen ruling options (LPI). Same set as the MIS lib/constants.js
// so portal-placed jobs slot in cleanly with operator-placed ones.
...
export const TURNAROUND_TIERS = [
  {
    id: "standard",
    label: "Standard",
    sub: "3 to 5 working days",
    upliftPct: 0,
  },
  {
    id: "express",
    label: "Express",
    sub: "1 to 2 working days",
    upliftPct: 25,
  },
];
