// Single source of truth for the 7-stage flexographic workflow.
...
export function isInProduction(stageId) {
  // Anything between artwork and plates (inclusive) is "in production" for customers.
  const i = STAGE_INDEX[stageId];
  return i !== undefined && i >= 0 && i <= 4;
}
